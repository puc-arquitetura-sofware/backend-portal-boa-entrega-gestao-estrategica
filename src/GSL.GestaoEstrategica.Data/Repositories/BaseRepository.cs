using GSL.GestaoEstrategica.Dominio.Interfaces.Repository;
...
namespace GSL.GestaoEstrategica.Data.Repositories
{
    public abstract class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : class
    {
        ...
        protected readonly GestaoEstrategicaDbContext _dbContext;

        public BaseRepository(GestaoEstrategicaDbContext dbContext)
        {
